...
public class CalculatorPage extends AbstractPage {
    ...
    private WebElement buttonResults;
    ...
    public CalculatorPage choiceChapter() {
        computeEngineButton.click();
        return this;
    }
    ...
    public CalculatorResultsPage pressResultsButton() {
        executor.executeScript("arguments[0].click()", buttonResults);
